...
const blog_content = {
    ...
    title:"ສາລະໜ້າຮູ້ ແລະ ຄວາມຮູ້ກ່ຽວກັບໄຟຟ້າ",
}
...
const BlogArea = () => {
    return (
        <>
        <div className="tp-blog-area blue-bg pb-50">
                  ...
                  <div className="row align-items-end tp-blog-four-section-space">
                     ...
                     <div className="col-xl-6 col-lg-6 wow tpfadeRight" data-wow-duration=".9s" data-wow-delay=".5s">
                        <div className="tp-blog-four-btn text-start text-lg-end">
                           <Link className="tp-btn-yellow-border" href="#">ເບິ່ງ​ເພີ່ມ​ເຕີມ <i className="far fa-angle-right"></i></Link>
                        </div>
                     </div>
                  </div>
                  <div className="row">
                    {know_data.map((item, i) => 
                        <div key={i} className="col-xl-4 col-lg-4 col-md-4 mb-40 wow tpfadeUp" data-wow-duration=".9s"
                            data-wow-delay=".7s">
                            ...
                            <div className="tp-blog-four-content-wrapper">
                                ...
                                <div className="tp-blog-four-info">
                                    <h4 className='fs-4 text-white'><Link href="#">{item.title}</Link></h4>
                                    
                                </div>
                                <div className="tp-blog-four-btn pt-3 ">
                                    <Link className="tp-btn-service" href="#">ອ່ານ​ຕື່ມ</Link>
                                </div>
                            </div>
                            </div>
                        </div>
