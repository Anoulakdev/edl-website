    ...
    <>
      <div className="sidebar__widget mb-40">
        <div className="sidebar__widge-title-box">
          <h3 className="sidebar__widget-title" style={{ fontFamily: 'Noto Sans Lao', fontSize: '25px' }}>ແຈ້ງ​ປະ​ມູນລ່າ​ສຸ​ດ</h3>
        </div>
        <div className="sidebar__widget-content">
          <div className="sidebar__post rc__post" >
            {recent_post_data.slice(0,4).map((item, i) => (
              <div key={i} className="rc__post mb-20 d-flex" style={{
                boxShadow: "0 3px 8px rgba(0, 0, 0, 0.6)",
                borderRadius: "20px",
              }}>
                <div className="rc__post-thumb mr-20 pt-10 pb-10">
                  <Link href="/blog-details">
                    <Image src={item.imagePath} alt="theme-pure" />
                  </Link>
                </div>
                <div className="rc__post-content">
                  <h3 className="rc__post-title pt-10 pb-10">
